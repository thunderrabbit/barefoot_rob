---
title: "Is Your Emotional Inbox Overflowing?"
tags: [ "imfine", "emotional awareness", "men", "self-assessment", "offerings" ]
author: Rob Nugen
...
<div class="quiz-intro" style="background-color: #FFF8EE; padding: 30px; border-radius: 8px; margin: 20px 0;">
...
<noscript>
<p style="font-weight: bold;">You don't have Javascript enabled, and that's okay! Here are the questions. For each one, give yourself 0–3 points based on which answer fits you best, then add up your total at the end.</p>

<ol>
<li><strong>When someone asks how you're doing, what's your gut reaction?</strong>
<ul>
<li>(0) I answer truthfully if I trust the person</li>
<li>(1) I know I'm not fine but say it anyway</li>
<li>(1) I say what I actually feel</li>
<li>(2) I say 'good' or 'fine' without thinking</li>
<li>(3) I genuinely don't know how I feel</li>
</ul></li>

<li><strong>How often do you feel a tension or heaviness you can't explain?</strong>
<ul>
<li>(0) Rarely</li>
<li>(1) Sometimes — maybe weekly</li>
<li>(2) Most days</li>
<li>(3) It's basically my default state</li>
</ul></li>

<li><strong>When you get angry, what happens next?</strong>
<ul>
<li>(0) I notice it, name it, and decide how to respond</li>
<li>(1) I push it down and move on</li>
<li>(2) It leaks out sideways — sarcasm, silence, short temper</li>
<li>(3) I explode, then feel guilty about it</li>
</ul></li>

<li><strong>When was the last time you cried?</strong>
<ul>
<li>(0) I cried this week</li>
<li>(0) Within the past month</li>
<li>(1) Within the past year</li>
<li>(2) I honestly can't remember</li>
<li>(2) I can't stop crying</li>
<li>(3) I physically can't — even when I want to</li>
</ul></li>

<li><strong>If a close friend asked 'what are you afraid of?' — could you answer honestly?</strong>
<ul>
<li>(0) Yes, I could name specific fears</li>
<li>(1) I'd probably deflect with a joke</li>
<li>(2) I'd feel uncomfortable and change the subject</li>
<li>(3) No one in my life would ask me that</li>
</ul></li>

<li><strong>How many people in your life know what you're actually going through right now?</strong>
<ul>
<li>(0) Several — I have people I trust</li>
<li>(1) One or two, maybe</li>
<li>(2) People know the surface version</li>
<li>(3) Nobody. I handle things alone.</li>
</ul></li>

<li><strong>When something painful happens, what do you do with it?</strong>
<ul>
<li>(0) Breathe and sit through it</li>
<li>(0) Talk about it or journal through it</li>
<li>(1) Distract myself until it fades</li>
<li>(2) Tell myself it's not a big deal</li>
<li>(3) Lock it away and keep going</li>
</ul></li>

<li><strong>How does your body feel right now?</strong>
<ul>
<li>(0) Relaxed — I can feel my body clearly</li>
<li>(1) Some tension but nothing unusual</li>
<li>(2) Tight — jaw, shoulders, chest</li>
<li>(3) I don't really notice my body much</li>
</ul></li>

<li><strong>When someone you care about says 'we need to talk,' what happens inside you?</strong>
<ul>
<li>(0) I'm curious about what they need</li>
<li>(1) Mild anxiety but I can handle it</li>
<li>(2) I brace for impact — walls go up</li>
<li>(3) Dread. I start planning my defense.</li>
</ul></li>

<li><strong>If you could change one thing about how you handle emotions, would you?</strong>
<ul>
<li>(0) I'm mostly satisfied with where I am</li>
<li>(1) I'd like to be better but it's not urgent</li>
<li>(2) Yes — I know something needs to shift</li>
<li>(3) I've known for a long time. I just don't know how.</li>
</ul></li>
</ol>
...
<!-- Quiz will be rendered by JavaScript -->
