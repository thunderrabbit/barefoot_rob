...
our %walk_location_files = (
    "yoyogi_park" => "$home/barefoot_rob_master/templates/walk_and_talk/yoyogi_park.en.md",
    "izumi_tamagawa" => "$home/barefoot_rob_master/templates/walk_and_talk/izumi_tamagawa.en.md",
    "shin_yuri_art_park" => "$home/barefoot_rob_master/templates/walk_and_talk/shin_yuri_art_park.en.md",
);

our %event_template_files = (
    "blog_entry" => "$home/barefoot_rob_master/templates/blog_template.md",
    "book_chapter" => "$home/barefoot_rob_master/templates/book_chapter_template.md",
    "weekly_alignment" => "$home/barefoot_rob_master/templates/event_weekly-alignment_template.md",
    "walking_meditation" => "$home/barefoot_rob_master/templates/event_walking_meditation_template.md",
    "barefoot_walk" => "walk_location_files",
    "quest_update" => "$home/barefoot_rob_master/templates/niigata_2021_walking_update.md",
);
